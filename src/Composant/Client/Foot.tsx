...
export default function FooterBar() {
  ...
  const clientLinks = [
    { id: 1, label: "Accueil", route: "/client" },
    { id: 2, label: "Services", route: "/client/services" },
    { id: 3, label: "Messagerie", route: "/client/messagerie" },
    { id: 4, label: "Compte", route: "/client/compte" },
    { id: 5, label: "Wallet", route: "/wallet" },
  ];
        ...
        <div className="flex justify-between items-start flex-wrap gap-6 mb-6">
          ...
          <div className="flex gap-12 flex-wrap">
            {[
              { 
                title: "Navigation", 
                links: clientLinks.map(l => ({ label: l.label, to: l.route })) 
              },
              { 
                title: "Légal", 
                links: [
